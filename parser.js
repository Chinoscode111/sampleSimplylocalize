...
//     const nodePath = nodeInfo.path.slice(1); 
//     const nodeXPath = ['/', ...nodePath.map(index => `*[${index + 1}]`)].join('');
//     return { ...nodeInfo, xpath: nodeXPath };
//   });
// };
// const parsedData = parsePage(document.body);

// const applyStylesToDom = (parsedNodes) => {
//   parsedNodes.forEach(nodeInfo => {
//     const modifiedText = nodeInfo.text;
//     if (nodeInfo.node.tagName === 'INPUT' || nodeInfo.node.tagName === 'TEXTAREA') {
//       nodeInfo.node.setAttribute('placeholder', modifiedText);
//     } else {
//       nodeInfo.node.textContent = modifiedText;
//     }
//   });
// };
// console.log(parsedData)
// applyStylesToDom(parser);
...
apiresponse = {"Domain":"https://yogendrapawar.online/","Phrases":[{"PhraseHash":"ead164f91f600f8140bf89c4112ace88","PhraseKey":"Welcome to Our Website","Phrase":"欢迎访问我们的网站","PhraseDetails":[{"UrlPath":"https://www.simplylocalize.com/home","XPath":"/*[2]*[1]"}]},{"PhraseHash":"8a0bc2895a6f8bf291123745b215d0b1","PhraseKey":"© 2023 Company Name. All rights reserved.","Phrase":"© 2023 公司名称。保留所有权利。","PhraseDetails":[{"UrlPath":"https://www.simplylocalize.com/home","XPath":"/*[2]*[1]"}]},{"PhraseHash":"ee87f95cc23bb98dba331a9767cab790","PhraseKey":"Capitalize Selected Text","Phrase":"大写所选文本","PhraseDetails":[{"UrlPath":"https://www.simplylocalize.com/home","XPath":"/*[1]"}]}]}
